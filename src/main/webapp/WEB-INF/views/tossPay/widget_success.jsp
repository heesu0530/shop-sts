...
<body>
	<div class="box_section" style="width: 600px">
		...
		<div class="p-grid" style="margin-top: 30px">
			...
			onclick="location.href='https://docs.tosspayments.com/guides/v2/payment-widget/integration';">연동 문서</button>
			<button class="button p-grid-col5" 
			onclick="location.href='https://discord.gg/A4fRFXQhRu';" style="background-color: #e8f3ff; color: #1b64da">실시간 문의</button>
		</div>
	</div>
    ...
    async function confirm() {
      ...
      const response = await fetch("/views/tossPay", {
        method: "POST",
        headers: {
