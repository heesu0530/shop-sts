...
<!-- Theme color -->
<link id="switcher"  type="text/css" href="/css/theme-color/default-theme.css" rel="stylesheet">
<!-- <link id="switcher" href="css/theme-color/bridge-theme.css" rel="stylesheet"> -->
<!-- Top Slider CSS -->
<link type="text/css" href="/css/sequence-theme.modern-slide-in.css" rel="stylesheet" media="all">
								...
								<div class="aa-language">
									<div class="dropdown">
										<a class="btn dropdown-toggle" href="#" type="button" id="dropdownMenu1"
											...
											src="img/flag/korea.png">KOREA<span class="caret"></span>
										</a>
									</div>
								</div>
								<!-- / language -->
								...
								<div class="aa-currency">
									<div class="dropdown">
										<a class="btn dropdown-toggle" href="#" type="button" id="dropdownMenu1"
											...
											class="fa fa-won"></i>KRW <span class="caret"></span>
										</a>
									</div>
								</div>
								<!-- / currency -->
				...
				<div class="navbar navbar-default" role="navigation">
					...
					<div class="navbar-collapse collapse">
						...
						<ul class="nav navbar-nav">
							<li><a href="#">카테고리 <span class="caret"></span></a>
								<ul class="dropdown-menu">
									<li><a href="/frultProductList">과일</a></li>
									<li><a href="/vegeProductList">채소</a></li>
								</ul></li>
							<li><a href="/popularProductList">지금 인기있는</a></li>
							<li><a href="#">알뜰식품</a></li>
							<li><a href="#">커뮤니티 <span class="caret"></span></a>
								<ul class="dropdown-menu">
									<li><a href="/notice">공지사항</a></li>
									<li><a href="product-detail.html">오픈포럼</a></li>
								</ul></li>
						</ul>
					</div>
					<!--/.nav-collapse -->
