...
<body>
	...
	<section id="aa-catg-head-banner">
		<img src="img/bannerdetail/008.jpg" alt="fashion img">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="cart-view-area">
						<div class="cart-view-table aa-wishlist-table" style="padding: 30px; min-height: 200px; margin-bottom: 23%;">
							<form action="">
		                  ...
		                  <tbody>
		                  	<c:if test="${apiResult.responseCode == '0000'}">
			                    <tr style="text-align: center; height: 70px">
			                      <th>결제금액</th>
			                      <td colspan="3">
			                      	<input type="text" name="amount" value="${apiResult.amount}" class="num" readonly="readonly" style="all: unset">
			                      </td>
			                    </tr>
			                    <tr style="text-align: center; height: 70px">
			                      <th>카드사명</th>
			                      <td colspan="3">${apiResult.cardName}</td>
			                    </tr>
			                    </c:if>
		                    <c:if test="${apiResult.responseCode != '0000'}">
			                    <tr style="text-align: center; height: 70px">
